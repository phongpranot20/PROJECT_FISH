...
with col_right:
    ...
    with st.container():
        ...
        # แสดง Dashboard กราฟคู่และรูปปลา
    ...
    st.write("This AI model uses Convolutional Neural Networks to recognize 6 fish species. All data is processed securely.")
    st.markdown('</div>', unsafe_allow_html=True)
